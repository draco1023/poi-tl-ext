...
class HtmlRenderPolicyTest {
    ...
    void doRender() throws IOException {
        ...
        htmlRenderPolicy.setDebug(true);
        Configure configure = Configure.builder()
                .bind("teachContent", htmlRenderPolicy)
                .bind("plainContent", htmlRenderPolicy)
                .build();
        Map<String, Object> data = new HashMap<>(2);
        data.put("teachContent", readFile("/1.html"));
        data.put("plainContent", readFile("/2.html"));
    ...
    String readFile(String resourceFile) throws IOException {
        try (InputStream inputStream = HtmlRenderPolicyTest.class.getResourceAsStream(resourceFile)) {
